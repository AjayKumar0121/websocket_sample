...
const pool = new Pool({
  ...
  password: 'Password@12345', // update with your DB password
  port: 5432,
});
...
apiServer.listen(API_PORT, () => {
  console.log(`✅ Server + WebSocket running at http://localhost:${API_PORT}`);
});
...
loginApp.listen(LOGIN_PORT, () => {
  console.log(`🚪 Login page running at http://localhost:${LOGIN_PORT}`);
});
